...
clear
clc
cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all\20n'
...
for i=1:p_all
    for j=1:size(p,2)
        para(i,j)=p(1,j)+normrnd(0,0.2*p(1,j));
    end
end
m=mean(para,1);
s=std(para,1);
...
dlmwrite('EMT9_para_10000_20n.txt',para(1:10000,:),'-append');


%% 2. calculate the perturbed sss
clear;clc
para=load('EMT9_para_10000_20n.txt');
ntt=4000;dtt=0.1;
for i1=1:length(para)
    ...
    dlmwrite('EMT9_kdt_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdss_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdS_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kd3_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdzz_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdZ_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kd2_all_10000_20n.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kde_all_10000_20n.txt',sol_all,'-append');
end
% 9 kdn
clear;clc
para=load('EMT9_para_10000_20n.txt');
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdn_all_10000_20n.txt',sol_all,'-append');
end
...
clear;clc;
cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20n'
sss_all=load('EMT9_kdt_all_10000_20n.txt'); % change, for the nine sss file
sss_all0=sss_all;
...
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20n\E'
% dlmwrite('EMT9_kdT_E_10000_20n.txt',sss_phen1,'-append');
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20n\H'
% dlmwrite('EMT9_kdT_H_10000_20n.txt',sss_phen2,'-append');
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20n\M'
% dlmwrite('EMT9_kdT_M_10000_20n.txt',sss_phen3,'-append');

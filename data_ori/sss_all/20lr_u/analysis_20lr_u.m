...
clear
clc
cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all\20lr_u'

p_all=10000;
for i=1:p_all
    kdt=0.6*(0.8+0.4*rand(1));
    kds=0.09*(0.8+0.4*rand(1));
    kdS=1.66*(0.8+0.4*rand(1));
    kd3=0.03*(0.8+0.4*rand(1));
    kdz=0.09*(0.8+0.4*rand(1));
    kdZ=1.66*(0.8+0.4*rand(1));
    kd2=0.035*(0.8+0.4*rand(1));
    kde=0.5*(0.8+0.4*rand(1));
    kdn=0.5*(0.8+0.4*rand(1));
    para(i,:)=[kdt,kds,kdS,kd3,kdz,kdZ,kd2,kde,kdn];
end
dlmwrite('EMT9_para_10000_20lr_u.txt',para,'-append');


%% 2. calculate the perturbed sss
% 1 kdt
clear;clc
para=load('EMT9_para_10000_20lr_u.txt');
ntt=4000;dtt=0.1;
for i1=1:length(para)
    ...
    dlmwrite('EMT9_kdt_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdss_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdS_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kd3_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdzz_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdZ_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kd2_all_10000_20lr_u.txt',sol_all,'-append');
end
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kde_all_10000_20lr_u.txt',sol_all,'-append');
end
% 9 kdn
clear;clc
para=load('EMT9_para_10000_20lr_u.txt');
...
for i1=1:length(para)
    ...
    sol_all(all(sol_all==0,2),:)=[];
    dlmwrite('EMT9_kdn_all_10000_20lr_u.txt',sol_all,'-append');
end
...
clear;clc;
cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20lr_u'
sss_all=load('EMT9_kdt_all_10000_20lr_u.txt'); % change, for the nine sss file
sss_all0=sss_all;
...
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20lr_u\E'
% dlmwrite('EMT9_kdT_E_10000_20lr_u.txt',sss_phen1,'-append');
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20lr_u\H'
% dlmwrite('EMT9_kdT_H_10000_20lr_u.txt',sss_phen2,'-append');
% cd 'E:\huqing\PhD\all_paper\a2_MRA\all_code\data_ori\sss_all_20lr_u\M'
% dlmwrite('EMT9_kdT_M_10000_20lr_u.txt',sss_phen3,'-append');

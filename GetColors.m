...
%
c_string{1} = {'#E74745', '#80D172', '#F57F4B', '#64B6EA', '#F4B414', '#8C8FD5'};
c_string{2} = {'#979797', '#1AC0C6', '#FD91A0', '#7298AB', '#CD84F1', '#D4C114'};
c_string{3} = {'#FAB4AC', '#C0E5BC', '#FAD390', '#FEFB66', '#BDF4FC', '#C3BCE6'};
c_string{4} = {'#F48FB1', '#F6C4E6', '#ECE70B', '#FEFB66', '#A0D284', '#CCFF9A'};
c_string{5} = {'#A788EB', '#D7BCE7', '#7F8C8D', '#C9C9C9', '#F8A427', '#FFD0A1'};

c_string{6} = {'#8C8FD5', '#F4B414', '#64B6EA', '#F57F4B', '#80D172', '#E74745'};
c_string{7} = {'#D4C114', '#CD84F1', '#7298AB', '#FD91A0', '#979797', '#1AC0C6'};
c_string{8} = {'#C3BCE6', '#BDF4FC', '#FEFB66', '#FAD390', '#C0E5BC', '#FAB4AC'};
c_string{9} = {'#CCFF9A', '#A0D284', '#FEFB66', '#ECE70B', '#F6C4E6', '#F48FB1'};
c_string{10} = {'#FFD0A1', '#F8A427', '#C9C9C9', '#7F8C8D', '#D7BCE7', '#A788EB'};

c_string{11} = {'#E74745', '#FB7857', '#FBCD60', '#FEFB66', '#1AC0C6', '#FB7857'};% 波西米亚风情
c_string{12} = {'#361D32', '#543C52', '#F65A53', '#EED2CB', '#DBD873', '#F1E8E8'};% WOF 旺德福
c_string{13} = {'#454D66', '#319975', '#58B368', '#DBD873', '#FAC46C', '#F1ECB7'};% 瑞普演界网
c_string{14} = {'#112E92', '#112E92', '#48D6D2', '#81EAE6', '#F8F6BA', '#E3F5F6'};% Georgia Holt
c_string{15} = {'#134036', '#103232', '#34C0B8', '#7A27FF', '#FFCA7B', '#F8A427'};% William Alexander
c_string{16} = {'#FF0000', '#F65A53', '#34C0B8', '#7A27FF', '#FF98A4', '#D7BCE7'};% 配色1
c_string{17} = {'#F84D4D', '#FF6B42', '#5BA3EB', '#06BB9A', '#8E7EF0', '#F4B919'};% 配色2
c_string{18} = {'#406196', '#F4B414', '#77649B', '#385D77', '#576270', '#778495'};% 配色3
c_string{19} = {'#4C6CFF', '#18C1FF', '#3DEF2D', '#9818BC', '#CB1E86', '#FC564B'};% 配色4
c_string{20} = {'#0E9DFF', '#FF0000', '#800080', '#FFA500', '#ECE70B', '#979797'};% Reeoo
c_string{21} = {'#313BD0', '#9A22F8', '#00F2F2', '#00B2FC', '#5EAFFA', '#81E0D7'};% Encry
c_string{22} = {'#55EFC4', '#81ECEC', '#74B9FF', '#A29BFE', '#7F8C8D', '#C9C9C9'};% 小清新1
c_string{23} = {'#FAD390', '#F8C291', '#3742FA', '#70A1FF', '#82CCDD', '#B8E994'};% 蓝色精灵
c_string{24} = {'#F8E0F1', '#DEC8CC', '#B87D9C', '#82447F', '#0B174E', '#C9C9C9'};% 单色调
c_string{25} = {'#0063C3', '#408AD2', '#3396CF', '#A0D284', '#F5CD39', '#BEBEBE'};% Amgen
c_string{26} = {'#4316F3', '#8769F7', '#FA807C', '#EFC09D', '#A5A5A5', '#C9C9C9'};% Vectary
% 墨镜
